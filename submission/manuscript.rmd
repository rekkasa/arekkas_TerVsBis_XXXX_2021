...
\newpage
```{r overallCovariateBalance, cache = TRUE, echo = FALSE, fig.cap="Calibrated overall results"}
grid::grid.raster(tiff::readTIFF(here("figures/OverallCovariateBalance.tiff")))
```

\newpage
```{r overallPsDensity, cache = FALSE, echo = FALSE, fig.cap="Calibrated overall results"}
grid::grid.raster(tiff::readTIFF(here("figures/OverallPsDensity.tiff")))
```

\newpage
```{r overallNcPlot, cache = FALSE, echo = FALSE, fig.cap="Overall negative control plot."}
