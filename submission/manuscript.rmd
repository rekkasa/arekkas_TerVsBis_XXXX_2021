...
A total of `r sum(incidenceOverall$maxTreatment) + sum(incidenceOverall$maxComparator)` patients were initially considered for our analyses. Of those, `r sum(incidenceOverall$maxTreatment)` received teriparatide and `r sum(incidenceOverall$maxComparator)` received an oral bisphosphonate \@ref(tab:table1).
